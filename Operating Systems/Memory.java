...
public class Memory {
  ...
  //  public void dmaTransfer(DMAController dmaController, int source, int destination, int size, boolean isToRAM, CPU callback) {
    //    dmaController.setupTransfer(source, destination, size, isToRAM, callback);
   //     new Thread(dmaController).start();
    //}
}
